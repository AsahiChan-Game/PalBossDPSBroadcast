...
$vdf = @(
    ...
    '    "changenote" "v1.1.0: Added automatic localization for all 17 Palworld languages."'
    '}'
) -join "`r`n"
...
$metadata.changenote = "v1.1.0: Added automatic localization for all 17 Palworld languages."
$metadata.last_published_version = "1.1.0"
